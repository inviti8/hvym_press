...
parser.add_argument(
    "--test", help="copy executable to local install directory", action="store_true"
)
parser.add_argument(
    "--mac", help="copy executable to mac local install directory", action="store_true"
)
...
subprocess.run(
    [
        ...
        "--add-data",
        f"images{add_data_sep}images",
        "--add-data",
        f"serve{add_data_sep}serve",
    ],
    check=True,
)
